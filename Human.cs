...
namespace programming_paradigms
{
    class Human
    {
        ...
        public Human(string name, string surname, string nationality) : this()
        {
            Name = name;
            Surname = surname;
        ...
        public Human(string name, string surname, string nationality, Gender gender, int day, int month, int year):this(name, surname, nationality)
        {
            Sex = gender;
